...
<head>
    ...
    <script type="text/javascript">
        <?php
            ...
            $resultbatch = CRest::CALL('user.get');
        ...
        function formReport(){
            ...
            //Сохранить эти элементы в json формате для сохранения отчета
            //отобразить отчет

            if (selectedValues.length !== 0 && reportName !== 'null' && reportDescription !== 'null' && workers.length !== 0){
                $.ajax({
                    type: 'POST',
                    url: 'extra-report-param-window.php',
                    data: {
...
<header>
    ...
    <div id="report-param-panel-create" onclick="formReport()">
        ...
        <div id="report-param-panel">
            <div id="report-name-block">
                ...
                <div>
                    ...
                    <textarea id="report-name" style="margin-bottom: 5px">Название отчета</textarea>
                </div>
                <div>
                    <text>Описания отчета</text>
                    <textarea id="report-description" style="margin-bottom: 5px">Описание отчета</textarea>
                </div>
            </div>
            <div id="report-filter-block">
                ...
                <div>
                    ...
                    <input type="date" name="calendar" value="2012-06-01" max="2099-12-30" min="2012-01-1" style="margin-right: 87px;" id="datebegin"">
                    <input type="date" name="calendar" value="2023-06-01" max="2099-12-30" min="2012-01-1" id="dateend"">
                </div>
                <div>
                    <text>Сотрудники</text>
                    <select id="worker" style="position: relative; width: 300px; height: auto; overflow-y: scroll" multiple>
                    </select>
                </div>
                <div>
